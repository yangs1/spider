...
class Mysqli
{
    ...
    public static $tryConnectCount = 5;
    public static $currentConnectCount = 0;
    /**
     * Table prefix
     * @var string
     */
...
//        }
        if (self::$currentConnectCount > self::$tryConnectCount){
            $msg = $this->mysqli()->error . " query: " . $this->_query;
            $num = $this->mysqli()->errno;
            $this->reset();
            throw new \Exception($msg, $num);
        ...
        if(!$stmt){
            ...
            $msg = $this->mysqli()->error . " query: " . $this->_query . " in ". self::$currentConnectCount;
